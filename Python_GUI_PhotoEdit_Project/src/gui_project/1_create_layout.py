...
btn_add_file = Button(file_frame, padx=5,width=12,text="Add File")
btn_add_file.pack(side="left")

btn_del_file= Button(file_frame, padx=5,width=12,text="Select Delete")
...
btn_dest_path= Button(path_frame, text="Search", width=0)
